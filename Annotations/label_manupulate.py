...
def change_class_number(label_dir, label_ext=".txt", old_class=50, new_class=30):
...
label_dir = 'E:\python\INFOSYS_INTERNSHIP\code_file\Infosys Springboard_image_manupulation_testing\Annotations\LABEL\labeled_txtfile'
