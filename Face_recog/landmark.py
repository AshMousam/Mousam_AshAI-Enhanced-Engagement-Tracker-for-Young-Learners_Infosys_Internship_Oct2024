...
try:
    while True:
        ...
        for (top, right, bottom, left), face_encoding in zip(face_locations, face_encodings):
            ...
            if distance < 0.6:
                ...
                attentive = abs(yaw[0]) < 0.4 and abs(pitch[0]) < 0.4
    ...
    if not df.empty:
        df.to_excel('mousam_attendance_with_attention.xlsx', index=False)
        print("Attendance with attentiveness saved to 'mousam_attendance_with_attention.xlsx'.")
